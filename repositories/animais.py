...
def get_last_movements_bulk(animal_ids: list[str]) -> dict[str, str]:
    ...
    last_movements = {}
    with _conn() as con:
        # SQLite limit is typically 999 parameters (older versions) or 32766 (newer).
        # PostgreSQL doesn't have this limit and doesn't easily translate json_each.
        # Batch by 900 to be portable and safe.
