...
void main() {
  ...
  testWidgets(
    'fluxo de telas cobre login, refresh, lista, ficha, pesagem e sanidade',
    (tester) async {
      ...
      final client = MockClient((request) async {
        ...
        if (request.method == 'GET' &&
          ...
          return _json({'carencia_ate': carenciaAte, 'aplicacoes': aplicacoes});
        }
      ...
      expect(
        find.widgetWithText(TextFormField, 'Ivermectina 1%'),
        findsOneWidget,
      );
      ...
      await tester.enterText(
        find.byKey(const ValueKey('medication-date')),
        '2026-08-22',
      );
