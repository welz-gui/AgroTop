...
ESCURO = {
    ...
    "sucesso_secundario":   "#34d399",
    "atencao":              "#fbbf24",
    "atencao_escuro":       "#854d0e",
    "atencao_fundo":        "#422006",
    "atencao_fundo_alt":    "#713f12",
    "atencao_secundario":   "#fb923c",
    "atencao_brilhante":    "#facc15",
    "perigo":               "#f87171",
    "perigo_escuro":        "#7f1d1d",
    "perigo_fundo":         "#450a0a",
    "info":                 "#22d3ee",
    "info_secundario":      "#3b82f6",
    "info_texto":           "#60a5fa",
    "info_fundo":           "#1e3a5f",
    "destaque":             "#a78bfa",
    "destaque_secundario":  "#f472b6",
}
...
CLARO = {
    ...
    "sucesso_secundario":   "#059669",
    "atencao":              "#b45309",
    "atencao_escuro":       "#854d0e",
    "atencao_fundo":        "#fef3c7",
    "atencao_fundo_alt":    "#fef9c3",
    "atencao_secundario":   "#ea580c",
    "atencao_brilhante":    "#ca8a04",
    "perigo":               "#b91c1c",
    "perigo_escuro":        "#7f1d1d",
    "perigo_fundo":         "#fee2e2",
    "info":                 "#0e7490",
    "info_secundario":      "#2563eb",
    "info_texto":           "#1d4ed8",
    "info_fundo":           "#cffafe",
    "destaque":             "#6d28d9",
    "destaque_secundario":  "#db2777",
}
