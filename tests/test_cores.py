"""Testes de integridade da paleta de cores e auditoria de tokens (Spec 0007)."""
...
class TestCores(unittest.TestCase):
    def test_nenhum_hex_literal_sem_token_em_app_py(self):
        """1. auditar_cores.py mostra `sem token: 0` ao final."""
