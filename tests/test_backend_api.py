"""Testes da API Backend em FastAPI (Spec 0044).
...
from backend_api.config import get_secret_key, ACCESS_TOKEN_EXPIRE_SECONDS, TOKEN_ALGORITHM, TOKEN_ISSUER
...
from repositories.pesagens import add_weighing, get_weighings
