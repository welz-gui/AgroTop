...
class TestMovimentacaoService(unittest.TestCase):
    ...
    def test_data(self):
        self.assertEqual(_data("2023-01-01"), date(2023, 1, 1))
        self.assertIsNone(_data("invalid-date"))
    ...
    def test_pre_validar_saida_contexto_padrao(self):
        problemas = pre_validar_saida(self.mov_valida, [self.animal_valido])
        self.assertEqual(problemas, [])
